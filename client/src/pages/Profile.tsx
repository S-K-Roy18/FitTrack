            ...
            <div className="profile-content">
                {/*left col*/}
                    <Card>
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            <div className="size-12 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-700 flex items-center justify-center shadow-md shadow-emerald-500/20">
                        ...
                        {isEditing ? (
                            ...
                            <div className="space-y-4">
                                ...
                                {/*Age*/}
                                <div className="flex iems-center gap-4 p-3 bg-slate-50 dark:bg-slate-800 rounded-lg transaction-colors duration-200">
                                    <div className="size-10 rounded-lg bg-blue-100 dark:bg-blue-900/20 flex items-center justify-center">
                                        <Calendar className="size-4.5mtext-blue-600 dark:text-blue-400"/>
                                    </div>
                                    <div>
                                        <p className="text-sm text-slate-500 dark:text-blue-400">Age</p>
                                ...
                                <div className="flex iems-center gap-4 p-3 bg-slate-50 dark:bg-slate-800 rounded-lg transaction-colors duration-200">
                                    <div className="size-10 rounded-lg bg-purple-100 dark:bg-purple-900/20 flex items-center justify-center">
                                        <Scale className="size-4.5mtext-purple-600 dark:text-purple-400"/>
                                    </div>
                                    <div>
                                        <p className="text-sm text-slate-500 dark:text-blue-400">Weight</p>
                                ...
                                {user.height !==0 &&(
                                    ...
                                    <div className="size-10 rounded-lg bg-green-100 dark:bg-green-900/20 flex items-center justify-center">
                                        <User className="size-4.5mtext-green-600 dark:text-green-400"/>
                                    </div>
                                    <div>
                                        <p className="text-sm text-slate-500 dark:text-blue-400">Height</p>
                                ...
                                <div className="flex iems-center gap-4 p-3 bg-slate-50 dark:bg-slate-800 rounded-lg transaction-colors duration-200">
                                    <div className="size-10 rounded-lg bg-orange-100 dark:bg-orange-900/20 flex items-center justify-center">
                                        <Target className="size-4.5mtext-orange-600 dark:text-orange-400"/>
                                    </div>
                                    <div>
                                        <p className="text-sm text-slate-500 dark:text-blue-400">Goal</p>
                ...
                {/*right col*/}
                    <div className="space-y-4">
                        ...
                        {/*toggle theme butoon for phone*/}
                        <div className="lg:hidden">
                            <button
                             onClick={toggleTheme} 
                             className="flex items-center gap-3 px-4 py-2.5 w-full test-slate-500 dark:text-slate-400 hover:bg-slate-50 dark;hover:bg-slate-800 hover-text-slate-700 dark:hover:text-slate-200 rounded-lg trasition-colors duration-200 cursor-pointer">
