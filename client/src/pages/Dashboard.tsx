        ...
        <div className="page-container">
           ...
           <div className="dashboard-grid">
            ...
            <Card className="shadow-lg col-span-2">
                ...
                {/* Goal Card */}
                {user &&( //This card will span both columns o large screens
                    <Card className="bg-gradient-to-r from-slate-800 to-slate-700">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-white font-semiboid capatalized">
                ...
                {user && user.weight && (
                    <Card>
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                <h3 className="font-semiboid text-slate-800 dark:text-white">Body Metrics</h3>
                                        ...
                                        {(()=>{
                                            ...
                                            const getStatus =(b: number) =>{
                                                if(b < 18.5) return {color : 'text-blue-500',
                                                    bg: 'bg-blue-500'};
                                                if(b < 25) return {color : 'text-green-500',
                                                    bg: 'bg-emerald-500'};
                                                if(b < 30) return {color : 'text-orange-500',
                                                    bg: 'bg-orange-500'};
