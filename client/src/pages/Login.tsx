              ...
              : "Please enter your details to create an Account."}
                ...
                {state !== "login" && (
                    <div className ="mt-4">
                        ...
                        <div className ="relative mt-2">
                            ...
                            <input onChange ={(e) => setUsername(e.target.value)} value={username} type="text" placeholder= "Enter a User Name" className="login-input " required/>
                        </div>
                     </div>
            )}
                {/*email*/}
                    <div className ="mt-4">
                        ...
                        <div className ="relative mt-2">
                            ...
                            <input onChange ={(e) => setEmail(e.target.value)} value={email} type="email" placeholder= "Please Enter Your Email" className="login-input " required/>
                        </div>
                     </div>
                {/*password*/}
                    <div className ="mt-4">
                        ...
                        <div className ="relative mt-2">
                            ...
                            <input onChange ={(e) => setPassword(e.target.value)} value={password} type={showPassword ? "text" : "password"} placeholder= "Please Enter Your Password" className="login-input pr-10" required />
                ...
                {state === "login" ? (
                    <p className="text-center py-6 text-sm text-gray-500 dark:text-gray-400">
                        Don't have an account? <button onClick={() => setState("signup")} className="ml-1 cursor-pointer text-green-600 hover:underline" >
                            Sign Up
                        </button>
                    </p>
                    )
                    ...
                    (
                        <p className="text-center py-6 text-sm text-gray-500 dark:text-gray-400">
                            Already have an account? <button onClick={()=> setState("login")} className="ml-1 cursor pointer text-green-600 hover:underline" >
                                Login
                            </button>
                        </p>
                    )}
